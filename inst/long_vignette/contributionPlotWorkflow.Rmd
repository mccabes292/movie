...
t1=makeContributionPlotObject(fullScores,cvScores,foldMem)
plot(t1,"SideBySide",xAxisPlot=1,yAxisPlot=2,colorVar=as.factor(gender),grid=F)
...
t1=makeContributionPlotObject(list("CNV"=fullContribution_CNV_MCCA[,1],"RNA"=fullContribution_RNA_MCCA[,1],"miRNA"=fullContribution_miRNA_MCCA[,1]),list("CNV"=cvContribution_CNV_MCCA[,1],"RNA"=cvContribution_RNA_MCCA[,1],"miRNA"=cvContribution_miRNA_MCCA[,1]),foldMem=as.vector(foldMem[,1]))
...
t1=makeContributionPlotObject(fullScoreAJIVE,cvScoreAjive,foldMem=as.vector(foldMem[,1]))


plot(t1,"SideBySide",xAxisPlot = 1,yAxisPlot = 2,grid=F, colorVar=as.factor(gender))
plot(t1,"SideBySide",xAxisPlot = 1,yAxisPlot = 3,grid=F, colorVar=as.factor(foldMem[,1]))
plot(t1,"SideBySide",xAxisPlot = 2,yAxisPlot = 3,grid=F, colorVar=as.factor(foldMem[,1]))
...
t1=makeContributionPlotObject(fullScoreMOFA,cvScoreMOFA,foldMem=as.vector(foldMem[,1]))
...
t1=makeContributionPlotObject(fullScoresPerm,permCV,foldMem)
plot(t1,"SideBySide",xAxisPlot=1,yAxisPlot=2,colorVar=as.factor(foldMem),grid=F)
plot(t1,"Comparison",xAxisPlot=2,yAxisPlot=2,colorVar=as.factor(foldMem),grid=T)
...
t1=makeContributionPlotObject(fullScoresMCCAPerm,cvScoresMCCAPerm,foldMem=as.vector(foldMem[,1]))
...
t1=makeContributionPlotObject(fullScoreAJIVEPerm,cvScoreAjivePerm,foldMem=as.vector(foldMem[,1]))
...
t1=makeContributionPlotObject(fullScoreMOFAPerm,cvScoreMOFAPerm,as.vector(foldMem[,1]))
...
t1=makeContributionPlotObject(list("CNV"=fullScore_CNV_MCCA_Clust[,1],"RNA"=fullScore_RNA_MCCA_Clust[,1],"Mut"=fullScore_Mut_MCCA_Clust[,1]),list("CNV"=cvScore_CNV_MCCA_Clust[,1],"RNA"=cvScore_RNA_MCCA_Clust[,1],"Mut"=cvScore_Mut_MCCA_Clust[,1]),foldMem=as.vector(clustFold[,1]))
...
t1=makeContributionPlotObject(fullScoreAJIVE_Clust,cvScoreAjive_Clust,foldMem=as.vector(clustFold[,1]))
...
t1=makeContributionPlotObject(fullScoreMOFA_Clust,cvScoreMOFA_Clust,foldMem=as.vector(clustFold[,1]))
